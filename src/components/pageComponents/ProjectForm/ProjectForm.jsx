        ...
        <ProjectFormStyledComponent theme={theme}>
            ...
            <Grid container className={classes.mainContainer} spacing={2} >
                ...
                <Grid item container sm={6} xs={12} className={classes.column1} direction='column' >
                    <TextField label="Project Name" variant='outlined' className={classes.TextField} color="secondary" />
                    ...
                    <Grid container item xs={12} alignItems='flex-end'>
                        <Grid xs={4} item style={{paddingRight: '10px'}}> <TextField label="Start Date" type='date' fullWidth  className={classes.TextField} color='secondary' /> </Grid>
                    ...
                    <Grid container item xs={12} alignItems='flex-end'>
                        <Grid xs={4} item style={{paddingRight: '10px'}}> <TextField label="Start Date" type='date'  className={classes.TextField} color='secondary' fullWidth /> </Grid>
